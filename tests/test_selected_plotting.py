...
def test_plot_selected_cases_with_groups():
    with TemporaryDirectory() as tmp:
        root = Path(tmp)
        study_root = root / "studies" / "crimpability_radial_force"
        comparison_dir = study_root / "comparison"
        ...
        assert names == {
            ...
            "WY-AP_total_force_selected_sim_raw_data2.png",
            "WY-AP_total_force_selected_sim_raw_data_revision.png",
            "WY-CEEP_total_force_selected.png",
            "WY-CEEP_total_force_selected_sim_raw_data2.png",
            "WY-CEEP_total_force_selected_sim_raw_data_revision.png",
        }
